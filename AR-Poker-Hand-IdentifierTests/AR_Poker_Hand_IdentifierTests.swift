...
class AR_Poker_Hand_IdentifierTests: XCTestCase {
    ...
    func testRoyalFlush() {
        ...
        XCTAssert(resultHand.rawValue == "RoyalFlush", "Test for Royal Flush failed.");
    }
    ...
    func testStraightFlush() {
        ...
        resultHand = Evaluator(pokerHand);
        XCTAssert(resultHand.rawValue == "StraightFlush", "Test for Straight Flush failed.");
    }
    ...
    func testFourOfAKind() {
        ...
        resultHand = Evaluator(pokerHand);
        XCTAssert(resultHand.rawValue == "FourOfAKind", "Test for Four-Of-A-Kind failed.");
    }
    ...
    func testFullHouse() {
        ...
        resultHand = Evaluator(pokerHand);
        XCTAssert(resultHand.rawValue == "FullHouse", "Test for Full House failed.");
    }
    ...
    func testThreeOfAKind() {
        ...
        resultHand = Evaluator(pokerHand);
        XCTAssert(resultHand.rawValue == "ThreeOfAKind", "Test for Three-Of-A-Kind failed.");
    }
    ...
    func testTwoPair() {
        ...
        resultHand = Evaluator(pokerHand);
        XCTAssert(resultHand.rawValue == "TwoPair", "Test for Two Pair failed.");
    }
    ...
    func testOnePair() {
        ...
        resultHand = Evaluator(pokerHand);
        XCTAssert(resultHand.rawValue == "OnePair", "Test for One Pair failed.");
    }
    ...
    func testHighCard() {
        ...
        resultHand = Evaluator(pokerHand);
        XCTAssert(resultHand.rawValue == "HighCard", "Test for High Card failed.");
    }
